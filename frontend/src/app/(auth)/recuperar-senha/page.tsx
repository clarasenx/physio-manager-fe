...
export default function RecuperarSenha() {
  ...
  return (
    <section className='flex flex-col sm:justify-center md:items-center sm:h-screen w-full bg-[#F9F7F3] sm:rounded-l-2xl sm:rounded-t-none rounded-t-2xl px-4 sm:px-16 pt-5 sm:pt-0'>
      <Link href='/login' className="self-start mb-2 sm:mb-auto sm:mt-10 text-primary cursor-pointer flex items-center gap-1">
        <ArrowLeft size={25} />
        <span className='text-lg font-medium'>Voltar</span>
      </Link>
      <div className='flex flex-col w-full md:max-w-[500px] mb-auto pb-20 sm:px-6 sm:px-0'>
