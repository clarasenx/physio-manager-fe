...
export const ScheduleSchema = z.object({
  ...
  initialDiscomfort: z.number().int().min(0, {message: 'O valor mínimo é 0'}).max(10, {message: 'O valor maxímo é 10'}),
  finalDiscomfort: z.number().int().min(0, {message: 'O valor mínimo é 0'}).max(10, {message: 'O valor maxímo é 10'}),
