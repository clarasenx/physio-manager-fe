...
const Navbar = () => {
  ...
  return (
    <section className='flex z-50 flex-col h-dvh md:w-36 md:px-10 py-5 justify-items-center sm:items-center justify-between'>
        ...
        <div className="hidden md:flex h-[100px] w-[60px] bg-[#F1EDE3] rounded-4xl flex-col items-center justify-between py-2 my-9">
          <button
